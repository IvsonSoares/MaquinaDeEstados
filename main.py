...
from share.functions import valida_string 

n_arquivos = 3
listas_de_strings = [ open(f"./txt/strings_{x}.txt",'r').read().splitlines() for x in range(1, n_arquivos + 1, 1)]
